...
fm_faces3456 = '/home/thanuja/Dropbox/data/3D_Grid_ILP/trainingData/fm/cellFaceFMs/fm_faces3456.mat';
labels_faces3456 = '/home/thanuja/Dropbox/data/3D_Grid_ILP/trainingData/lblmat/gridCellFace3456Labels.mat';
...
fm = importdata(fm_faces3456);
labels = importdata(labels_faces3456);
[x,y] = binaryClassBalancing(fm,labels);
