...
% explored. 
%
% Note: The function Chapter_12_TrainDic can be replaced by
% Chapter_12_TrainDic_Fast, but this requires a proper instalation of 
% the K-SVD package from Ron Rubinstein - see
