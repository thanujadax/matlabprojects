function connectedJunctionIDs = labelJunctionClusterNeighbors(junctionInd,connectedJunctionIDs,junctionLabel,...
...
%             connectedJunctionIDs(listIndNeigh,2) = junctionID;
            connectedJunctionIDs = labelJunctionClusterNeighbors(indNeigh,connectedJunctionIDs,...
